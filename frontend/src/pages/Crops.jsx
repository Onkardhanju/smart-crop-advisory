...
const Crops = () => {
  ...
  const openEditModal = (crop) => {
    setEditCrop(crop)
    setFormData({
      farmId: crop.farmId?._id || crop.farmId,
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">
              Track and manage all your crops
            </p>
          </div>
          <button
              ...
              <div key={crop._id}
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                      🏡 {crop.farmId?.farmName || 'Unknown Farm'}
                    </p>
                  </div>
                ...
                {/* Growth Stage */}
                <div className="mb-4">
                  <span className={`text-xs px-3 py-1 rounded-full font-medium ${stageColors[crop.growthStage]}`}>
                    📈 {crop.growthStage}
                  </span>
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-screen overflow-y-auto">
            ...
            <div className="flex justify-between items-center p-6 border-b">
              <h2 className="text-lg font-bold text-gray-800">
                {editCrop ? '✏️ Edit Crop' : '🌱 Add New Crop'}
              </h2>
              <button
